  ...
  class="text-gray-600 body-font">
    ...
    class="container px-5 py-24 mx-auto">
      <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2  text-purple-700 ">Our Services</h1>
        <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">what we do..</p>
      </div>
      ...
      class="flex flex-wrap -m-4">
        ...
        <div class="xl:w-1/3 md:w-1/2 p-4 ">
          <div class="border border-gray-200 p-6 rounded-lg hover:bg-purple-300">
            ...
            <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Project Consultant</h2>
    ...
    on:enterViewport={() => console.log('enter!')}
        ...
        class="xl:w-1/3 md:w-1/2 p-4">
          <div class="border border-gray-200 p-6 rounded-lg hover:bg-purple-300">
            ...
            <h2 
            transition:fly
            class="text-lg text-gray-900 font-medium title-font mb-2">Ramona Falls</h2>
            <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
          </div>
        </div>
      </div>
