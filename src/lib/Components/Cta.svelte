	...
	<div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
		<div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
			...
			<p class="leading-relaxed mt-4">
				Our goal is to provide you with best service possible and we will full devotion to fulfil
				that.
			</p>
		</div>
		<div
		...
		>
			...
			<button
				class="text-white bg-my-nvy1 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg"
			>
				Submit</button
			>
