<section class="text-gray-600 body-font relative">
    <div class="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
      <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
        <iframe width="100%" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d28871.619911454298!2d70.82965314074988!3d22.817015936356377!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sShanidev%20Temple%20Salana%20Road%20Morbi%20-363641%20Gujarat-%20India!5e0!3m2!1sen!2sin!4v1669825832237!5m2!1sen!2sin" style="filter: grayscale(1) contrast(1.2) opacity(0.4);"></iframe>
        <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
          <div class="lg:w-1/2 px-6">
            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
            <p class="mt-1">Diaper Experts <br>M792, near Gujarat Housing Society Near Shanidev Temple Salana Road. <br>Morbi -363641 Gujarat- India</p>
          </div>
          <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
            <a href="/" class="text-purple-500 leading-relaxed">mamraj@diaperexpperts.in</a>
            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
            <p class="leading-relaxed">+91 82194 91416</p>
          </div>
        </div>
      </div>
      <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
        ...
        <button class="text-white  bg-my-nvy1 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded text-lg">Button</button>
